...
CREATE TABLE stock_entry(
    ...
    FOREIGN KEY (brand) REFERENCES brands(rowid) ON DELETE CASCADE,
    FOREIGN KEY (origin) REFERENCES countries(rowid) ON DELETE CASCADE,
    FOREIGN KEY (shop) REFERENCES shops(rowid) ON DELETE CASCADE,
    
    FOREIGN KEY (place) REFERENCES places(rowid) ON DELETE CASCADE
);
...
CREATE TABLE ref_r_entry(
    ...
    FOREIGN KEY (reference) REFERENCES stock_references(rowid) ON DELETE CASCADE,
    FOREIGN KEY (entry) REFERENCES stock_entries(rowid) ON DELETE CASCADE
);
...
CREATE TABLE tags_relation(
    ...
    FOREIGN KEY (parent) REFERENCES tags(rowid) ON DELETE CASCADE,
    FOREIGN KEY (child) REFERENCES tags(rowid) ON DELETE CASCADE,
...
CREATE TABLE ref_r_tag(
    ...
    FOREIGN KEY (reference) REFERENCES stock_references(rowid) ON DELETE CASCADE,
    FOREIGN KEY (tag) REFERENCES tags(rowid) ON DELETE CASCADE
);
